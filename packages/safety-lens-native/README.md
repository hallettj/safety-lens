...
This package provides lenses for native Javascript data types.
This package supplements the core lens package: [safety-lens][].

[safety-lens]: https://github.com/hallettj/safety-lens
